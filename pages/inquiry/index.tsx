...
const InquiryList = () => {
  ...
  const fetchComments = async (id: any) => {
    try {
      const response = await axiosPost(`${API_URL}/comments/List`, {
        inquiry_id: id,
      });
      if (response.status === 200) {
        // Handle successful response (status code 200)
  ...
  const handleInquiryTitleSearch = (
  ...
  const sendComment = async () => {
    try {
      const response = await axiosPost(`${API_URL}/comments/Register`, {
    ...
    <Box>
      ...
      <BlankCard>
        ...
        >
          ...
          <DeleteInquiry
            selectedInquiryIds={selected.join(",")}
            onClose={() => {
              fetchData();
              setSelected([]);
            }}
        ...
        <Paper
          variant="outlined"
          sx={{ mx: 2, my: 1, border: `1px solid ${borderColor}` }}
        >
          <TableContainer>
                  ...
                  .map((row: any, index: any) => {
                    ...
                    return (
                      ...
                      >
                        <TableCell padding="checkbox">
                          {(accountType == 0 ||
                            (accountType != 0 && row.author == author)) && (
                            <CustomCheckbox
                              color="primary"
                        ...
                        <TableCell>
                          ...
                          >
                            ...
                            {row.password && (
                              <LockIcon sx={{ ml: 1 }} fontSize="small" />
                            )}
                          </Box>
                        </TableCell>
                        <TableCell>
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={() => verifyPassword(passwordInput)}>
                Submit
              </Button>
            </DialogActions>
          </Dialog>
