    ...
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      <Box component="form" width={600}>
        {userInfo.user_id != null ? (
          <>
            {userInfo.user_type == 0 || userInfo.user_type == 3 ? (
              <>
                    ...
                    {editMode ? (
                      <>
                        <TableRow sx={{ border: "1px solid black" }}>
                          ...
                          <TableCell
                            sx={{ padding: 0, border: "1px solid black" }}
                          >
                            <TextField
                              sx={{ px: 1 }}
                              fullWidth
                      ...
                      {editMode ? (
                        <TextField
                          ...
                          onChange={(e) =>
                            setUserInfo({
                              ...userInfo,
                              manager_depart: e.target.value,
                            })
                          }
                        />
                      ) : (
                        <Typography sx={{ ml: 1 }}>
                          {userInfo.manager_depart}
                        </Typography>
                      )}
                    </TableCell>
                  </TableRow>
                      ...
                      {editMode ? (
                        <TextField
                          ...
                          onChange={(e) =>
                            setUserInfo({
                              ...userInfo,
                              manager_grade: e.target.value,
                            })
                          }
                        />
                      ) : (
                        <Typography sx={{ ml: 1 }}>
                          {userInfo.manager_grade}
                        </Typography>
                      )}
                    </TableCell>
                  </TableRow>
            ...
            <Box
              sx={{ display: "flex", justifyContent: "flex-end", marginY: 2 }}
            >
              {editMode ? (
      ...
      <Dialog open={showSuccessPopup} onClose={handleClosePopup}>
        ...
        <DialogActions>
          <Button
            onClick={() => {
              handleClosePopup(); /*router.push('/account/account-manager');*/
            }}
          >
            OK
          </Button>
