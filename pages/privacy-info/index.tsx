...
const PrivacyInfoTable: React.FC<PrivacyProps> = ({
  selectedItem,
  initPrivacyItems,
  onClose,
}) => {
  const [privacyItems, setPrivacyItems] =
    useState<PrivacyItem[]>(initPrivacyItems);
      ...
      const updatedRows = privacyInfos.map((row, rowIndex) => {
        if (rowIndex === selectedCell.rowIndex) {
          ...
          return {
            ...row,
            merged1: 0,
            standard_grade: privacyInfos[selectedCell.rowIndex].standard_grade,
          };
        }
        return row;
      });
      ...
      <Box sx={{ mb: 2, display: "flex", justifyContent: "space-between" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 1 }}>
          ...
          <Button
            ...
            disabled={
              selectedCell && privacyInfos.length > selectedCell.rowIndex
                ? privacyInfos[selectedCell.rowIndex].merged1 !== 1 ||
                  privacyInfos[selectedCell.rowIndex].merged2 !== 1
                : true
            }
          >
            행 삭제
