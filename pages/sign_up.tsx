...
const AccountTab: React.FC = () => {
  ...
  const handleAccountTypeChange = (event: any) => {
    ...
    if (event.target.value == 1) setBusinessNumber("000-00-00000");
  };
  ...
  const handleIdCheck = async () => {
    ...
    if (isDuplicate) {
      ...
      setDialogContent(
        "중복된 아이디가 존재합니다. 다른 아이디를 입력해 주세요."
      );
      setDialog1Open(true);
    } else {
      setDialogTitle("중복 확인");
          ...
          <TableBody>
            ...
            {!emailChecked && (
              <TableRow>
                ...
                >
                  <InputLabel htmlFor="password">인증번호</InputLabel>
                </TableCell>
                <TableCell sx={{ padding: 1 }}>
                  <TextField
                    fullWidth
