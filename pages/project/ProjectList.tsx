...
const CustomTableCell = (props: any) => {
  return <TableCell {...props} sx={{ padding: 1.2 }}></TableCell>;
};
...
const ProductTableList = () => {
  ...
  let y = [];
  for (let i = 0; i < 3; i++) registerYears.push(today.getFullYear() - i);
  ...
  React.useEffect(() => {
    ...
    if (companyList.length > 0) setCompanyId(companyList[0].user_id);
    else setCompanyId(0);

    if (checklist.length > 0) setCheckListId(checklist[0].id);
    else setCheckListId(0);

    if (personalCategory.length > 0) setPrivacyPolicy(personalCategory[0]);
    else setCheckListId(0);

    if (personalCategory.length > 0) setPrivacyPolicy(personalCategory[0].id);
                      ...
                      .map((row: any, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <CustomTableCell>
                              <Typography align="center">{row.year}</Typography>
                            </CustomTableCell>
            ...
            <DialogContent>
              ...
              <Box sx={{ display: "flex" }}>
                <input
                  type={"date"}
                  value={createFrom}
                  onChange={(e: any) => setCreateFrom(e.target.value)}
                />
                ...
                <input
                  type={"date"}
                  value={createTo}
                  onChange={(e: any) => setCreateTo(e.target.value)}
                />
              </Box>
              <Typography
                sx={{ mt: 2, mr: "auto", mb: 1 }}
                variant="h6"
                component="div"
              >
                자가 점검 기간
              ...
              <Box sx={{ display: "flex" }}>
                <input
                  type={"date"}
                  value={selfCheckFrom}
                  onChange={(e: any) => setSelfCheckFrom(e.target.value)}
                />
                <Typography sx={{ ml: 1, mr: 1 }} variant="h6" component="div">
                  ~
                </Typography>
                <input
                  type={"date"}
                  value={selfCheckTo}
                  onChange={(e: any) => setSelfCheckTo(e.target.value)}
                />
              </Box>
              <Typography
                sx={{ mt: 2, mr: "auto", mb: 1 }}
              ...
              <Box sx={{ display: "flex" }}>
                <input
                  type={"date"}
                  value={impCheckFrom}
                  onChange={(e: any) => setImpCheckFrom(e.target.value)}
                />
                <Typography sx={{ ml: 1, mr: 1 }} variant="h6" component="div">
                  ~
                </Typography>
                <input
                  type={"date"}
                  value={impCheckTo}
                  onChange={(e: any) => setImpCheckTo(e.target.value)}
                />
              </Box>
            </DialogContent>
            <DialogActions>
