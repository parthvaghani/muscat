  ...
  const handleAddItem = async () => {
    ...
    try {
      const response = await axiosPost(
        `${API_URL}/personal_category/Register`,
        newItem
      );
      if (response.status === 200) {
  ...
  const handleDeleteSelectedItems = async () => {
    try {
      const response = await axiosDelete(
        `${API_URL}/personal_category/Delete`,
      ...
      {showPrivacyInfo == false ? (
        <Box sx={{ width: "100%" }}>
          ...
          >
            ...
            <Button variant="contained" onClick={handleAddItemToggle}>
              추가
            </Button>
          </Toolbar>
                ...
                <TableRow>
                  <TableCell padding="checkbox">
                    <Checkbox
                      indeterminate={
                        selected.length > 0 &&
                        selected.length < privacyItems.length
                      }
                      checked={
                    ...
                    <TableCell>
                      <TextField
                        ...
                        onChange={(e) =>
                          setNewItem({
                            ...newItem,
                            personal_category: e.target.value,
                          })
                        }
                      />
                    </TableCell>
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={handleDeleteSelectedItems} color="error">
                삭제
              </Button>
            </DialogActions>
          </Dialog>
        ...
        <PrivacyInfoTable
          initPrivacyItems={privacyItems}
          selectedItem={selectPrivacyItem}
          onClose={() => {
